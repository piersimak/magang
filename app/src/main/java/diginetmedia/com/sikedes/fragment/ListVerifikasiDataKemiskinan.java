 ...
 */
public class ListVerifikasiDataKemiskinan extends Fragment {


    public ListVerifikasiDataKemiskinan() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_verifikasi_data_kemiskinan, container, false);
        init();
        return rootview;
    }
    private void init()
        ...
        recyclerViewKemiskinan.addOnItemTouchListener(
                new RecyclerItemClickListener(context, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent i = new Intent(context, VerifikasiDataKemiskinan.class);
                        Bundle b = new Bundle();
