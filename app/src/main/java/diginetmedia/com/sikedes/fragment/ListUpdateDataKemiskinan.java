...
import diginetmedia.com.sikedes.activity.UpdateDataKemiskinan;
 ...
 */
public class ListUpdateDataKemiskinan extends Fragment {


    public ListUpdateDataKemiskinan() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_update_data_kemiskinan, container, false);
        init();
        return rootview;
    }
    private void init()
        ...
        recyclerViewKemiskinan.addOnItemTouchListener(
                new RecyclerItemClickListener(context, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent i = new Intent(context, UpdateDataKemiskinan.class);
                        startActivity(i);
                    }
                })
        );
