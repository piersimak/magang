...
public class NormallListDataKemiskinanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NormallListDataKemiskinanAdapter(List<DataKemiskinan> dataKemiskinan, RecyclerView recyclerViewDataKemiskinan, Context con) {
    ...
    static class DataKemiskinanViewHolder extends RecyclerView.ViewHolder {
        ...
        public DataKemiskinanViewHolder(View itemView) {
            super(itemView);
            txtDataKemiskinan = (TextView) itemView.findViewById(R.id.txtNama);
        }
    }
